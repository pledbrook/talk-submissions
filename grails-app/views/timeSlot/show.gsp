...
<html>
    ...
    <body>
        ...
        <div id="show-timeSlot" class="content scaffold-show" role="main">
            ...
            <f:display bean="timeSlot" />
            <g:form resource="${this.timeSlot}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.timeSlot}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
