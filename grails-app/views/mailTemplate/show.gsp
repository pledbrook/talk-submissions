...
<html>
    ...
    <body>
        ...
        <div id="show-mailTemplate" class="content scaffold-show" role="main">
            ...
            <f:display bean="mailTemplate" />
            <g:form resource="${this.mailTemplate}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.mailTemplate}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
