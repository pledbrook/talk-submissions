...
<html>
    ...
    <body>
        ...
        <div id="edit-mailTemplate" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.mailTemplate}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.mailTemplate}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.mailTemplate}" method="PUT">
                <g:hiddenField name="version" value="${this.mailTemplate?.version}" />
                <fieldset class="form">
                    <f:all bean="mailTemplate"/>
                </fieldset>
