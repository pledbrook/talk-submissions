...
<html>
    ...
    <body>
        ...
        <div id="show-track" class="content scaffold-show" role="main">
            ...
            <f:display bean="track" />
            <g:form resource="${this.track}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.track}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
